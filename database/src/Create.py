...
class InitializeMasterDbCreator:
    ...
    def __InsertRepo(self, db_path):
        m = database.src.repo.insert.Main.Main(self.data)
        m.Initialize()
    ...
    def __InsertOtherRepo(self, db_path):
        ...
        main = database.src.other_repo.insert.Main.Main(self.data)
        main.Initialize()
    ...
    def __InsertLicenses(self, db_path):
        creator_license = database.src.license.insert.Main.Main(self.data)
